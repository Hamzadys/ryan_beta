...
if($pref['alt_uom'] == 1) {
	array_push($th, _("Date"), _("Detail"), _("Quantity In"), _("Sec.Quantity In"), _("Quantity Out")
		, _("Sec.Quantity Out"), _("Quantity On Hand"), _("Sec.Quantity On Hand"));
}
else{
...
if($pref['alt_uom'] == 1)
$header_span = $display_location ? 9 : 4;
else
$header_span = $display_location ? 6 : 4;
...
while ($myrow = db_fetch($result))
{
	...
	if($pref['alt_uom'] == 1)
	label_cell((($myrow["qty"] >= 0) ? $sec_quantity_formatted : ""), "nowrap align=right");
