...
label_row(_("Discount1 :"), price_format($_SESSION['View']->discount1), "align=right colspan=20",
	"nowrap align=right", 1);
label_row(_("Discount2 :"), price_format($_SESSION['View']->discount2), "align=right colspan=20",
	"nowrap align=right", 1);

label_row(_("Sub Total"), $display_sub_tot, "align=right colspan=20",
	"nowrap align=right", 1);


$taxes = $_SESSION['View']->get_taxes();

$tax_total = display_edit_tax_items($taxes, 20, $_SESSION['View']->tax_included,2);

$display_total = price_format($sub_tot + $tax_total);

start_row();
label_cells(_("Amount Total"), $display_total, "colspan=20 align='right'","align='right'");
