...
ref_cells(_("Customer Short Name"), 'debtor_ref', '',null, '', true);
...
currencies_list_cells(_("Customer's Currency"), 'curr_code', null, true, false, 1);
...
dimensions_list_cells("Dimension 1", 'dimension_id', null, true, " ", 1);
dimensions_list_cells("Dimension 2", 'dimension2_id', null, true, " ", 2);
...
$cols = array(
	_("Customer Name"),
	_("Customer Short Name"),
	_("Address"),
	_("NTN No"),
	_("STRN"),
	_("Customer's Currency"),
...
echo '<center><a href="customers.php" target="_blank"><input type="button" value="Add Customer"></a></center>';
