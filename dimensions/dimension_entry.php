...
if (isset($_POST['ADD_ITEM']) || isset($_POST['UPDATE_ITEM'])) 
{
	...
	if (can_process()) 
	{
		...
		if ($selected_id == -1) 
		{
			$id = add_dimension($_POST['ref'], $_POST['name'], $_POST['type_'], $_POST['date_'], $_POST['due_date'], $_POST['memo_'], $_POST['cust_name'], $_POST['sales_person'], $_POST['area'], $_POST['ref_1'], $_POST['ref_2'], $_POST['ref_3']);
		...
		else 
		{
			...
			update_dimension($selected_id, $_POST['name'], $_POST['type_'], $_POST['date_'], $_POST['due_date'], $_POST['memo_'], $_POST['cust_name'], $_POST['sales_person'], $_POST['area'], $_POST['ref_1'], $_POST['ref_2'], $_POST['ref_3']);
