...
function commit_item_data($n)
{
	if (check_item_data($n))
	{
		...
		$_SESSION['supp_trans']->add_grn_to_trans($n, $_POST['po_detail_item'.$n],
			...
			$_POST['text6'.$n],$_POST['amount1'.$n],$_POST['amount2'.$n],$_POST['amount3'.$n],$_POST['amount4'.$n],$_POST['amount5'.$n],
			$_POST['amount6'.$n],
            $_POST['date1'.$n],$_POST['date2'.$n],$_POST['date3'.$n],$_POST['combo1'.$n],$_POST['combo2'.$n],$_POST['combo3'.$n],$_POST['combo4'.$n],$_POST['combo5'.$n],
			$_POST['combo6'.$n],$_POST['batch'.$n]);
		reset_tax_input();
	}
}
