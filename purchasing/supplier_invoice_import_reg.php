...
if (isset($_GET['New']))
{
	...
	$_SESSION['supp_trans'] = new supp_trans_import(ST_SUPPINVOICE);//isko change kerian tu us ka ref ly ata hy
...
//		S.H
		...
		$Gross_Amt = input_num('ChgPrice'.$n)*input_num('this_quantity_inv'.$n) *$_SESSION['supp_trans']->Currency_Amount;
